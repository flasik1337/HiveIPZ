...
--
-- Host: localhost:3306
-- Czas generowania: 06 Maj 2025, 18:12
...
--
-- Zrzut danych tabeli `comment_reports`
--

INSERT INTO `comment_reports` (`id`, `comment_id`, `event_id`, `user_id`, `reason`, `reported_at`) VALUES
(4, 11, '1744735018402', 38, 'nie podoba mi się wypowiedź kolegi', '2025-04-16 06:36:59'),
(5, 11, '1744735018402', 38, 'nie pozdrawiam', '2025-04-16 06:37:38'),
(6, 12, '1744152579559', 12, 'bo tak', '2025-04-16 06:38:50'),
(7, 14, '1742372732146', 38, 'fuj', '2025-04-16 07:50:00');
...
('1742335399867', 'After-party po Rabbicie', 'Dom Filipa, Szczecin', 'AfterParty', 'Outdoor', '2025-04-10 00:00:00', 5, 3, 'assets/placeholder.jpg', 66, 20.00, 0, 1, 0),
('1742372732146', 'RabbIT', 'Wydział Informatyki ZUT', 'Wydział Informatyki ZUT', 'Firmowe', '2025-04-09 00:00:00', -1, 7, 'assets/rabbit.jpg', 38, 0.00, 1, NULL, 2),
('1742940594689', 'Gotowanie z Oliwka', 'wi zut', 'wi zut', 'Brak typu', '2025-03-25 23:08:53', 5, 5, 'assets/placeholder.jpg', 41, 0.00, 0, 1, 1),
...
('1744152579559', 'testowa ocena', 'domek', 'domek', 'Brak typu', '2025-04-09 00:00:00', -1, 3, 'assets/placeholder.jpg', 38, 0.00, 0, NULL, 2),
('1744152583645', 'testowa ocena', 'domek', 'test', 'Brak typu', '2025-04-09 00:00:00', -1, 2, 'assets/placeholder.jpg', 38, 0.00, 0, NULL, 1),
('1744735018402', 'Kawka Na Wynos', 'Szczecin', 'Testowanie organizatora wydarzenia i calej reszty', 'Brak typu', '2025-04-22 00:00:00', -1, 1, 'assets/placeholder.jpg', 38, 0.00, 0, NULL, 0);
...
--
-- Struktura tabeli dla tabeli `event_chat_messages`
--
...
(10, '1744152583645', 38, 'Test komentowania', '2025-04-15 16:32:07'),
(11, '1744735018402', 38, 'Test komentarza', '2025-04-15 16:53:54'),
(12, '1744152579559', 38, 'kocham pudziana', '2025-04-15 17:55:04'),
(13, '1744735018402', 38, 'kawa średnia', '2025-04-16 06:36:36'),
(14, '1742372732146', 38, 'IPZ', '2025-04-16 07:48:58');
...
(90, '1742372732146', 38, '2025-03-19 08:25:27', 'TKT805357'),
...
(153, '1744735018402', 38, '2025-04-15 16:37:00', 'gBqBjMAcErdviQCLd6w5QQ'),
(167, '1742372732146', 12, '2025-04-16 06:37:08', '9KbIaBxt9Rv15BVsQpM9xw'),
(168, '1744152579559', 12, '2025-04-16 06:44:42', 'mFSyW0tA0Ip7LOr_fl4_DQ'),
(169, '1742940594689', 12, '2025-04-16 07:22:09', 'ZCHlFNicsE5NfrdeF3BMwQ'),
(170, '1742372732146', 66, '2025-04-16 07:33:30', 'yq_sVB4yul_W09TIuDAXeA'),
(172, '1742372732146', 39, '2025-04-16 07:53:50', 'FEm5AQ3xuD-a2jPiBkqDag'),
(173, '1742335399867', 38, '2025-04-26 14:09:19', 'qIi82j3pXHqESxNuk5aGzQ');
...
--
-- Zrzut danych tabeli `event_reports`
--
...
(14, '1742372732146', 'Spam', 38, '2025-04-15 16:48:37'),
(15, '1744152583645', 'Spam', 38, '2025-04-16 06:39:44');
...
--
-- Zrzut danych tabeli `organizer_ratings`
--
...
(26, 66, 38, 3, '2025-04-15 17:45:27'),
(27, 38, 39, 5, '2025-04-16 07:32:00'),
(28, 38, 66, 1, '2025-04-16 07:33:40');
...
INSERT INTO `tickets` (`id`, `user_id`, `event_id`, `payment_id`, `purchase_date`, `status`, `price`) VALUES
('BEhTWR1EJpc', 12, '1744152579559', NULL, '2025-04-16 06:44:42', 'active', 0.00),
('ISDFlKsConI', 12, '1742940594689', NULL, '2025-04-16 07:22:09', 'active', 0.00),
('l-fjj68MKZU', 66, '1742372732146', NULL, '2025-04-16 07:33:30', 'active', 0.00),
('MFVf1m8hidA', 12, '1742372732146', NULL, '2025-04-16 06:37:08', 'active', 0.00),
('r-f1GmwhkZA', 38, '1744735018402', NULL, '2025-04-15 16:37:00', 'active', 0.00),
('ticket_535105', 38, '1742372732146', NULL, '2025-04-15 16:12:36', 'active', 0.00),
('uQbTLiimPU8', 38, '1742335399867', NULL, '2025-04-26 14:09:19', 'active', 20.00),
('xkf56KgOSe0', 38, '1742335399867', NULL, '2025-04-16 07:38:28', 'active', 20.00),
('z6mWsHQSfQM', 39, '1742372732146', NULL, '2025-04-16 07:53:50', 'active', 0.00);
...
(38, 'test@mail.to', 'test', 'testlogin', 'sEozY48nEuALL0fz042kq2fx9VcMyhPW-sg5lZrtFGk', 'Android2', 'JobsPOZMIANIE', 1, '', 25, 1, 2500, '["a", "szczecin"]'),
...
(66, 'test2', 'test', 'test2', NULL, 'Testowirońskii', 'Pomarańcz', 1, '', 33, 1, 0, ''),
...
(116, 'doggoone7@gmail.com', '', 'doggoone7', NULL, 'Filip Fojna', '', 1, NULL, 18, 1, 0, '[]');
...
(12, '2025-04-16 06:37:03', '2025-08-14 06:37:03', 0),
(14, '2025-04-08 20:33:58', '2025-08-06 20:33:58', 0),
(38, '2025-05-06 13:23:52', '2025-09-03 13:23:52', 0),
(39, '2025-04-16 07:53:45', '2025-08-14 07:53:45', 0),
(41, '2025-03-25 23:43:32', '2025-07-23 23:43:32', 0),
(42, '2025-04-15 16:40:40', '2025-08-13 16:40:40', 0),
(65, '2025-03-25 21:21:59', '2025-07-23 21:21:59', 0),
(66, '2025-04-16 07:33:16', '2025-08-14 07:33:16', 0),
...
--
-- Zrzut danych tabeli `user_event_preferences`
--
...
(80, 116, 'Domówka'),
(83, 14, 'Domówka'),
(84, 38, 'Impreza masowa'),
(85, 38, 'Motoryzacyjne'),
(86, 38, 'Relaks'),
(87, 38, 'Warsztaty'),
(88, 66, 'Sportowe'),
(89, 66, 'Impreza masowa'),
(90, 66, 'Warsztaty');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `user_promotions`
--

CREATE TABLE `user_promotions` (
  `id` int NOT NULL,
  `user_id` int NOT NULL,
  `reward_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `acquired_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Zrzut danych tabeli `user_promotions`
--

INSERT INTO `user_promotions` (`id`, `user_id`, `reward_type`, `active`, `acquired_at`) VALUES
(2, 38, 'promo_ticket', 1, '2025-04-16 07:36:58');
...
--
-- Indeksy dla tabeli `event_chat_messages`
--
...
--
-- Indeksy dla tabeli `user_promotions`
--
...
--
-- AUTO_INCREMENT dla tabeli `comment_reports`
--
ALTER TABLE `comment_reports`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT dla tabeli `event_bans`
--
ALTER TABLE `event_bans`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT dla tabeli `event_chat_messages`
--
ALTER TABLE `event_chat_messages`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `event_comments`
--
ALTER TABLE `event_comments`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT dla tabeli `event_likes`
--
ALTER TABLE `event_likes`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT dla tabeli `event_participants`
--
ALTER TABLE `event_participants`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;

--
-- AUTO_INCREMENT dla tabeli `event_reports`
--
ALTER TABLE `event_reports`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT dla tabeli `organizer_ratings`
--
ALTER TABLE `organizer_ratings`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT dla tabeli `user_event_preferences`
--
ALTER TABLE `user_event_preferences`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT dla tabeli `user_promotions`
--
ALTER TABLE `user_promotions`
...
--
-- Ograniczenia dla tabeli `comment_reports`
--
ALTER TABLE `comment_reports`
...
--
-- Ograniczenia dla tabeli `event_bans`
--
ALTER TABLE `event_bans`
...
--
-- Ograniczenia dla tabeli `event_chat_messages`
--
ALTER TABLE `event_chat_messages`
...
--
-- Ograniczenia dla tabeli `event_participants`
--
ALTER TABLE `event_participants`
...
--
-- Ograniczenia dla tabeli `user_event_preferences`
--
ALTER TABLE `user_event_preferences`
  ADD CONSTRAINT `user_event_preferences_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Ograniczenia dla tabeli `user_promotions`
--
ALTER TABLE `user_promotions`
  ADD CONSTRAINT `user_promotions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
